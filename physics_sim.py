...
class PhysicsSim():
    ...
    def reset(self):
        self.time = 0.0
        # https://discussions.udacity.com/t/bug-initial-values-of-physics-sim-are-getting-overwritten/681482
    ...
    def next_timestep(self, rotor_speeds):
        ...
        # No self.angular_accels * self.dt * self.dt, should be self.angular_accels * self.angular_accels * self.dt
        # For example https://www.cliffsnotes.com/study-guides/physics/classical-mechanics/rotational-motion-of-a-rigid-body
        # The third of the kinematics equations
